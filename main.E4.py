...
class Net(nn.Module):
    def __init__(self):
        ...
        # If 4 layers
        self.fc3 = nn.Linear(2 * 15 * 15, 2*15*15)
        # self.fc4 = nn.Linear(2*15*15,8)

        # If 5 layers
        self.fc4 = nn.Linear(2 * 15 * 15, 2*15*15)
        # self.fc5 = nn.Linear(2*15*15,8)
        
        # If 6 layers
        self.fc5 = nn.Linear(2 * 15 * 15, 2*15*15)
        self.fc6 = nn.Linear(2*15*15,8)
...
def main():
    ...
    samples = []
    labels = []
    data_dir = "./IPARC_ChallengeV2/Dataset/One_SE-erosion/"
